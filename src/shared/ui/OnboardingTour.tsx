...
const TOUR_STEPS: TourStep[] = [
  {
    title: 'Добро пожаловать в Заботу',
    body: 'Забота — это приложение, которое поможет тебе справиться с тревогой, стрессом, паническими атаками и просто тяжёлыми моментами. Здесь есть простые упражнения, дневник и план безопасности. Всё работает без интернета и бесплатно.',
  ...
  {
    title: 'Важно знать',
    body: 'Забота не заменяет консультацию врача. Если у тебя сильная тревога, панические атаки или другие тяжёлые состояния — обратись к специалисту. Это не слабость, это забота о себе.',
